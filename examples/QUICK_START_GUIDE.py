...
print("   - cookies/browser/x_cookie.json (原系统)")
...
print("\n   方案二推荐测试代码:")
print("   ```python")
print("   from deepalpha.intel_router_v2 import decide")
print("   decision = decide(\"油价会涨吗？\")")
print("   ")
print("   # 然后使用您原有的 crawler_runner.py")
print("   from deepalpha.crawler_runner import build_tasks, run_all_tasks")
print("   # ... 运行原有的抓取流程")
print("   ")
print("   # 最后使用 cleaner_v2.py 清洗")
print("   from deepalpha.cleaner_v2 import clean_tweets")
print("   cleaned = clean_tweets(raw_tweets)")
print("   ```")

print("\n📌 步骤 4: 完整测试新版系统")
print("   ```python")
print("   from deepalpha.main_v2 import XIntelSystem")
