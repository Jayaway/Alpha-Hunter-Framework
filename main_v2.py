...
from intel_router_v2 import IntelRouter, Decision
from hybrid_crawler import HybridCrawlerEngine, IdentityPoolManager, CrawlTask, Tweet
from cleaner_v2 import clean_tweets, CleanedTweet, quick_filter
from signal_judge import judge_all_signals, judge_signal
...
class XIntelSystem:
    ...
    def quick_query(
        ...
        from hybrid_crawler import quick_crawl
